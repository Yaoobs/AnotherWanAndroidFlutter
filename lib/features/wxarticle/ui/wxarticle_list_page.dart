...
class WxArticleListPage extends ConsumerStatefulWidget {
  const WxArticleListPage({super.key, required this.params});
  final Map params;

  @override
  ConsumerState createState() => WxArticleListPageState();
}

class WxArticleListPageState extends ConsumerState<WxArticleListPage>
  ...
  Widget build(BuildContext context) {
    ...
    final articleListState = ref.watch(
      wxArticleListViewModelProvider(widget.params['id']),
    );
