...
class ArticleCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                ...
                article.type == 1
                    ? Container(
                        ...
                        child: LabelBox(text: "置顶"),
                      )
                    : Container(),
                article.fresh == true
                    ? Container(
                        margin: EdgeInsets.only(right: 15),
                        child: LabelBox(text: "New"),
                      )
                    : Container(),
                Text(
                  "$authorTitle$author",
    ...
    Column column = Column(children: <Widget>[row, title, chapterName]);
...
class LabelBox extends StatelessWidget {
  const LabelBox({super.key, required this.text, this.color});
  final String? text;
  final Color? color;
  @override
  Widget build(BuildContext context) {
