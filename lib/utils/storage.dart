...
import 'package:anotherwanandroidflutter/utils/encrypt_util.dart';
...
class StorageUtil {
  ...
  Future<bool>? setString(String key, String value, {bool encrypt = false}) {
    ...
    if (encrypt) {
      value = EncryptUtils.aesEncrypt(value, Constants.SECRET_KEY);
    }
  ...
  String? getString(String key, {bool encrypt = false}) {
    ...
    if (encrypt && str != null) {
      str = EncryptUtils.aesDecrypt(str, Constants.SECRET_KEY);
    }
    return str;
  }
